...
/*****************************************************************************************
 * // class IPAddress // Purpose: This class represents the four octets and
 * subnet mask of an IP address // Author: Linda Crane September 2015 // data
 * members: address - array of four ints for each octet // subnet - number of
 * network bits (CIDR notation) // methods: constructor // initialize - with int
 * array [4] and subnet parameters // initialize - with object of type IPAddress
 * // readFile - reads address info from parameter ifstream object - returns
 * boolean whether valid Ip was read // readKeyboard - reads valid info from
 * keyboard // isValid - returns true/false if IP address is valid // toString -
 * displays contents to a String (return) // getNetwork - returns appropriate
 * network address in IPAddress parameter // isEqual bases decision if two
 * objects are on same network (have same network number) //
 ***************************************************************************************/
class IPAddress {
