 ...
 *          Method hashCode() by Mark Kaganovsky, December 2015.
 * 
 * DATA MEMBERS: 
...
class IPAddress {
	...
	/**
	 * The hashcode returned is the 3rd octet. <br>
	 * 
	 * @return The 3rd octet.<br>
	 *         For example: if the IP address was <b>192.168.2.4</b>, the value returned would be <b>2</b>. 
	 */
	@Override
	public int hashCode(){
		return address[2];
