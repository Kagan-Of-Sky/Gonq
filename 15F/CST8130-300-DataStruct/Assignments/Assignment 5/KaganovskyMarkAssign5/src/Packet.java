...
public abstract class Packet {
	 ...
	 * @return A boolean value indicating to the Router whether or not to add this packet to the routing table (true = add to table).
	 */
	public abstract boolean processNotFoundPacket(String port, int index);
	
	/** Return the hashcode for the destination IP of this packet. */
	@Override
	public int hashCode(){
		return destinationip.hashCode();
	}
}