...
/* Buffer modes. 
 * The constants XXXXXXXXX_ARG are for the arguments passed to the b_create()
 * The constants without the _ARG postfix are what the BufferDescriptor.mode field is actually set to.
 */
