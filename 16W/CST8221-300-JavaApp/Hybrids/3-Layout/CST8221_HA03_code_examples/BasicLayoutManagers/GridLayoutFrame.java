// Chapter 14: GridLayoutFrame.java
...
public class GridLayoutFrame extends JFrame implements ActionListener 
{
   ...
   private static final long serialVersionUID = -6347069995542699798L;
...
/*IMPORTANT NOTE by S. Ranev
The Container validate method should  be called any time when the container
subcomponents are modified after the container has already been displayed.
For example, a subcomponent is added or removed from the container,
or layout-related settings changed.
To update a component you should call the Component revalidate() method
*/      
